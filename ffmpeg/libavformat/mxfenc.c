...
static const MXFLocalTagPair mxf_local_tag_batch[] = {
    ...
    { 0x3218, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x05,0x04,0x01,0x03,0x02,0x09,0x00,0x00,0x00}}, /* Active Format Descriptor*/
    ...
    { 0x330B, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x05,0x03,0x01,0x02,0x01,0x0A,0x00,0x00,0x00}}, /* Reversed Byte Order */
    ...
    { 0x3D10, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x05,0x04,0x02,0x05,0x01,0x02,0x00,0x00,0x00}}, /* Channel Status Mode */
    { 0x3D11, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x05,0x04,0x02,0x05,0x01,0x03,0x00,0x00,0x00}}, /* Fixed Channel Status Data */
    // Index Table Segment
    { 0x6101, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x05,0x06,0x01,0x01,0x04,0x02,0x0C,0x00,0x00}}, /* Descriptive Metadata Framework */
    ...
    { 0x9001, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x03,0x00,0x00}}, /* AVC B Picture Flag*/
    { 0x9002, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x04,0x00,0x00}}, /* AVC Coded Content Kind*/
    { 0x9003, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x06,0x00,0x00}}, /* AVC Closed GOP Indicator*/
    { 0x9004, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x07,0x00,0x00}}, /* AVC Identical GOP Indicator*/
    { 0x9005, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x08,0x00,0x00}}, /* AVC Maximum GOP Size*/
    { 0x9006, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x09,0x00,0x00}}, /* AVC Maximum B-Picture Count*/
    { 0x9007, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x0A,0x00,0x00}}, /* AVC Profile*/
    { 0x9008, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x0B,0x00,0x00}}, /* AVC Maximum Bit Rate*/
    { 0x9009, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x0C,0x00,0x00}}, /* AVC Profile Constraint */
    { 0x900A, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x0D,0x00,0x00}}, /* AVC Level */
    { 0x900B, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x0E,0x00,0x00}}, /* AVC Decoding Delay*/
    { 0x900C, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x0F,0x00,0x00}}, /* AVC Maximum Ref Frames*/
    { 0x900D, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x10,0x00,0x00}}, /* AVC Sequence Parameter Set Flag*/
    { 0x900E, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x11,0x00,0x00}}, /* AVC Picture Parameter Set Flag*/
    { 0x900F, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0E,0x04,0x01,0x06,0x06,0x01,0x14,0x00,0x00}}, /* AVC Average Bit Rate*/
    { 0x9010, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x09,0x06,0x01,0x01,0x04,0x06,0x10,0x00,0x00}}, /* SubDescriptors */
    //Text-Based
    { 0x8100, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0D,0x06,0x01,0x01,0x04,0x05,0x41,0x01,0x00}}, /*Text-Based Object*/
    { 0x8101, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0D,0x04,0x06,0x08,0x06,0x00,0x00,0x00,0x00}}, /*Text-Based Metadata Payload Scheme Identifier */
    { 0x8102, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0D,0x04,0x09,0x02,0x02,0x00,0x00,0x00,0x00}}, /*Text MIME Media Type */
    { 0x8103, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0D,0x03,0x01,0x01,0x02,0x02,0x14,0x00,0x00}}, /*RFC 5646 Text Language Code */
    { 0x8104, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0D,0x03,0x02,0x01,0x06,0x03,0x02,0x00,0x00}}, /*Text Data Description */
    { 0x8105, {0x06,0x0E,0x2B,0x34,0x01,0x01,0x01,0x0D,0x03,0x01,0x02,0x20,0x03,0x01,0x00,0x00}}, /*UTF-8 Text Data */
...
static void mxf_write_primer_pack(AVFormatContext *s)
{
    ...
    if (!will_have_avc_tags && !will_have_ffv1_tags) {
        mxf_mark_tag_unused(mxf, 0x9010);
    }

    if (!will_have_avc_tags) {
        mxf_mark_tag_unused(mxf, 0x900B);
        mxf_mark_tag_unused(mxf, 0x9007);
        mxf_mark_tag_unused(mxf, 0x900A);
    }
...
static void mxf_write_preface(AVFormatContext *s)
{
    ...
    klv_encode_ber_length(pb, 138 + 16LL * DESCRIPTOR_COUNT(mxf->essence_container_count) - 8);
...
static void mxf_write_identification(AVFormatContext *s)
{
    ...
    length = 100 +mxf_utf16_local_tag_length(company) +
                  ...
                  mxf_utf16_local_tag_length(version) - 14 - 14 - 30;
...
static int64_t mxf_write_cdci_common(AVFormatContext *s, AVStream *st, const UID key)
{
    ...
    if (key != mxf_rgba_descriptor_key) {
        ...
        // Reversed Byte Order 
        mxf_write_local_tag(s, 1, 0x330B);
        avio_w8(pb, 0);
    ...
    // if (sc->signal_standard) {
        ...
        avio_w8(pb, 0); //sc->signal_standard);
    // }
    ...
    mxf_write_local_tag(s, 4, 0x3211);
    avio_wb32(pb, 0x00);
    ...
    if (st->codecpar->codec_id == AV_CODEC_ID_H264 && !sc->avc_intra) {
        ...
        mxf_write_local_tag(s, 8 + 16, 0x9010);
        mxf_write_refs_count(pb, 1);
...
static void mxf_write_avc_subdesc(AVFormatContext *s, AVStream *st)
{
    ...
    mxf_write_local_tag(s, 1, 0x9001);
    avio_w8(pb, 0x01);  // AVC Constant B Picture Flag

    mxf_write_local_tag(s, 1, 0x9002);
    avio_w8(pb, 0x01);

    mxf_write_local_tag(s, 1, 0x9003);
    avio_w8(pb, 0x01);

    mxf_write_local_tag(s, 1, 0x9004);
    avio_w8(pb, 0x01);

    mxf_write_local_tag(s, 2, 0x9005);
    avio_wb16(pb, 0x01);

    mxf_write_local_tag(s, 2, 0x9006);
    avio_wb16(pb, 0x00);

    mxf_write_local_tag(s, 1, 0x9007);
    avio_w8(pb, st->codecpar->profile);
    // avio_w8(pb, 0x7A);

    mxf_write_local_tag(s, 1, 0x9009);
    avio_w8(pb, 0x10); 
    
    mxf_write_local_tag(s, 1, 0x900A);
    avio_w8(pb, st->codecpar->level);
    // avio_w8(pb, 0x34);  

    mxf_write_local_tag(s, 1, 0x900B);
    avio_w8(pb, 0x00);

    mxf_write_local_tag(s, 1, 0x900C);
    avio_w8(pb, 0x00);

    mxf_write_local_tag(s, 1, 0x900D);
    avio_w8(pb, 0x20);

    mxf_write_local_tag(s, 1, 0x900E);
    avio_w8(pb, 0x20);

    mxf_write_local_tag(s, 4, 0x9008);
...
static int64_t mxf_write_wav_common(AVFormatContext *s, AVStream *st, const UID key)
{
    ...
    const uint8_t chnanl_status[] = {0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x01};
    const uint8_t fixed_chnanl_status[] = {0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x18, 0x85, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    ...
    mxf_write_local_tag(s, 9, 0x3D10);
    
    avio_write(pb, chnanl_status, 9);

    mxf_write_local_tag(s, 32, 0x3D11);
    avio_write(pb, fixed_chnanl_status, 32);
...
static void mxf_write_package(AVFormatContext *s, MXFPackage *package)
{
    ...
    int name_size = 0; //mxf_utf16_local_tag_length(package->name);
...
static void mxf_write_index_table_segment(AVFormatContext *s)
{
    ...
    if (!mxf->edit_unit_byte_count) {
        ...
        mxf_write_local_tag(s, 8, 0x3F0A);
        avio_wb32(pb, 0x00);
        avio_wb32(pb, 11);
    }
...
static const struct {
    ...
    {{ 0x06,0x0E,0x2B,0x34,0x04,0x01,0x01,0x0a,0x04,0x01,0x02,0x02,0x01,0x32,0x30,0x01 },1250304, 122, 0,  1 }, // AVC High 422 Intra XAVC Profiles Class 300 4K
    {{ 0x06,0x0E,0x2B,0x34,0x04,0x01,0x01,0x0a,0x04,0x01,0x02,0x02,0x01,0x32,0x30,0x01 },1999872, 122, 0,  1 }, // AVC High 422 Intra XAVC Profiles Class 480 4K
};
                                ...
                                AVPacket *pkt, MXFIndexEntry *e)
{
    ...
    if (st->codecpar->width == 4096) {
        sc->aspect_ratio = (AVRational){ 256, 135 };
    }
...
static int mxf_write_packet(AVFormatContext *s, AVPacket *pkt)
{
    ...
    if (st->codecpar->codec_type == AVMEDIA_TYPE_DATA) { 
        const uint8_t ANC_Data[] = {0x06,0x0E,0x2B,0x34,0x01,0x02,0x01,0x01,0x0D,0x01,0x03,0x01,0x17,0x01,0x02,0x01};
        avio_write(pb, ANC_Data, 16); // write key
    } else {
